<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/controls/AdminMaster.master" Title="Builder Account" CodeFile="default.aspx.vb" Inherits="Index"  %>
...
<h4>Builder Account Administration</h4>

<asp:HyperLink ID="lnkReturn" runat="server" Text="Return to Builders list"></asp:HyperLink><br /><br />
<asp:HyperLink ID="lnkEditBuilder" runat="server" Text="Edit this Builder"></asp:HyperLink><br /><br />
...
<p></p>
<%--<CC:OneClickButton id="AddNew" Runat="server" Text="Add New Builder Account" cssClass="btn"></CC:OneClickButton>--%>
<p></p>
...
<CC:GridView id="gvList" CellSpacing="2" CellPadding="2" runat="server" PageSize="50" AllowPaging="True" AllowSorting="True" HeaderText="In order to change display order, please use header links" EmptyDataText="There are no records that match the search criteria" AutoGenerateColumns="False" BorderWidth="0" PagerSettings-Position="Bottom">
	...
	<Columns>
		<asp:TemplateField>
		    <ItemTemplate>
		        <asp:Button ID="btnLogin" runat="server" Text="Login As Builder" CssClass="btn" CommandName="Login" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"BuilderAccountID") %>' OnClientClick="ChangeTarget()" />
		    </ItemTemplate>
		</asp:TemplateField>
		<asp:TemplateField>
		    <ItemTemplate>
		        <asp:Button ID="btnLoginNoReg" runat="server" Text="Bypass Registration" CssClass="btn" CommandName="LoginNoReg" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"BuilderAccountID") %>' OnClientClick="ChangeTarget()" />
		    </ItemTemplate>
		</asp:TemplateField>
		<asp:TemplateField>
			<ItemTemplate>
			<asp:HyperLink enableviewstate="False" runat="server" NavigateUrl= '<%# "edit.aspx?BuilderAccountID=" & DataBinder.Eval(Container.DataItem, "BuilderAccountID") & "&" & GetPageParams(Components.FilterFieldType.All) %>' ImageUrl="/images/admin/edit.gif" ID="lnkEdit">Edit</asp:HyperLink>
			</ItemTemplate>
		</asp:TemplateField>
		<asp:TemplateField>
			<ItemTemplate>
			<CC:ConfirmLink enableviewstate="False" Message="Are you sure that you want to remove this Builder Account?" runat="server" NavigateUrl= '<%# "delete.aspx?BuilderAccountID=" & DataBinder.Eval(Container.DataItem, "BuilderAccountID") & "&" & GetPageParams(Components.FilterFieldType.All) %>' ImageUrl="/images/admin/delete.gif" ID="lnkDelete">Delete</CC:ConfirmLink>
			</ItemTemplate>
		</asp:TemplateField>
		<asp:BoundField SortExpression="HID" DataField="HID" HeaderText="Historic ID"></asp:BoundField>
