<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" MasterPageFile="~/controls/AdminMaster.master" Inherits="Edit"  Title="Vendor Registration Customer Reference"%>

<asp:content ContentPlaceHolderId="ph" ID="Content" runat="server">
	
<h4><% If VendorRegistrationCustomerReferenceID = 0 Then %>Add<% Else %>Edit<% End If %> Vendor Registration Customer Reference</h4>
...
<CC:ConfirmButton id="btnDelete" runat="server" Message="Are you sure want to delete this Vendor Registration Customer Reference?" Text="Delete" cssClass="btn" CausesValidation="False"></CC:ConfirmButton>
