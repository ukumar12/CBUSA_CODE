<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" MasterPageFile="~/controls/AdminMaster.master" Inherits="Edit"  Title="Vendor Registration Financial Reference"%>

<asp:content ContentPlaceHolderId="ph" ID="Content" runat="server">
	
<h4><% If VendorRegistrationFinancialReferenceID = 0 Then %>Add<% Else %>Edit<% End If %> Vendor Registration Financial Reference</h4>
...
<CC:ConfirmButton id="btnDelete" runat="server" Message="Are you sure want to delete this Vendor Registration Financial Reference?" Text="Delete" cssClass="btn" CausesValidation="False"></CC:ConfirmButton>
