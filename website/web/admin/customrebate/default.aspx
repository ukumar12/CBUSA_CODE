<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/controls/AdminMaster.master" Title="Custom Rebate" CodeFile="default.aspx.vb" Inherits="Index"  %>
<asp:content ContentPlaceHolderId="ph" ID="Content" runat="server">

<h4>Custom Rebate Administration</h4>
...
<tr>
<th valign="top"><b>Custom Rebate Program I D:</b></th>
<td valign="top" class="field"><asp:DropDownList ID="F_CustomRebateProgramID" runat="server" /></td>
</tr>
<tr>
...
<p></p>
<CC:OneClickButton id="AddNew" Runat="server" Text="Add New Custom Rebate" cssClass="btn"></CC:OneClickButton>
<p></p>
...
<CC:GridView id="gvList" CellSpacing="2" CellPadding="2" runat="server" PageSize="50" AllowPaging="True" AllowSorting="True" HeaderText="In order to change display order, please use header links" EmptyDataText="There are no records that match the search criteria" AutoGenerateColumns="False" BorderWidth="0" PagerSettings-Position="Bottom">
	...
	<Columns>
		<asp:TemplateField>
			<ItemTemplate>
			<asp:HyperLink enableviewstate="False" runat="server" NavigateUrl= '<%# "edit.aspx?CustomRebateID=" & DataBinder.Eval(Container.DataItem, "CustomRebateID") & "&" & GetPageParams(Components.FilterFieldType.All) %>' ImageUrl="/images/admin/edit.gif" ID="lnkEdit">Edit</asp:HyperLink>
			</ItemTemplate>
		</asp:TemplateField>
		<asp:TemplateField>
			<ItemTemplate>
			<CC:ConfirmLink enableviewstate="False" Message="Are you sure that you want to remove this Custom Rebate?" runat="server" NavigateUrl= '<%# "delete.aspx?CustomRebateID=" & DataBinder.Eval(Container.DataItem, "CustomRebateID") & "&" & GetPageParams(Components.FilterFieldType.All) %>' ImageUrl="/images/admin/delete.gif" ID="lnkDelete">Delete</CC:ConfirmLink>
			</ItemTemplate>
		</asp:TemplateField>
		...
		<asp:BoundField SortExpression="CustomRebateProgramID" DataField="CustomRebateProgramID" HeaderText="Custom Rebate Program I D"></asp:BoundField>
		...
		<asp:BoundField DataField="RebateAmount" HeaderText="Rebate Amount" DataFormatString="{0:c}" HTMLEncode="False"></asp:BoundField>
	</Columns>
</CC:GridView>
