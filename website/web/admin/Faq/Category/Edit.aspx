<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" MasterPageFile="~/controls/AdminMaster.master" Inherits="Edit"  Title="Faq Category"%>
...
<table border="0" cellspacing="1" cellpadding="2">
	...
	<tr>
		...
		<td><asp:RequiredFieldValidator ID="rfvCategoryName" runat="server" Display="Dynamic" ControlToValidate="txtCategoryName" ErrorMessage="Field 'Category Name' is blank"></asp:RequiredFieldValidator></td>
	</tr>
	<tr>
