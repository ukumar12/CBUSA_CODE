<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/controls/AdminMaster.master" Title="Banner" CodeFile="groups.aspx.vb" Inherits="groups"  %>
<asp:content ContentPlaceHolderId="ph" ID="Content" runat="server">

<h4>Banners</h4>

<p>
Banner Group Association for <b><% =dbBanner.Name%></b> | <a href="/admin/banners/default.aspx?<%= GetPageParams(Components.FilterFieldType.All,"F_BannerId") %>">&laquo; Go Back To Store Banner List</a>
</p>
...
<CC:GridView id="gvList" CellSpacing="2" CellPadding="2" runat="server" AllowPaging="False" AllowSorting="False" HeaderText="" EmptyDataText="There are no groups in which this image will fit." AutoGenerateColumns="False" BorderWidth="0" PagerSettings-Position="Bottom">
	...
	<Columns>
		<asp:TemplateField>
		<ItemTemplate>
		<input type="hidden" id="BannerGroupId" runat="server" value='<%#Container.DataItem("BannerGroupId")%>' />
		<input type="hidden" id="UniqueId" runat="server" value='' />
		<asp:Checkbox id="chkGroup" runat="server"></asp:Checkbox>
		</ItemTemplate>
		</asp:TemplateField>
        <asp:BoundField SortExpression="Name" DataField="Name" HeaderText="Group Name"></asp:BoundField>
		<asp:TemplateField>
		<HeaderTemplate>
		Date Range
		</HeaderTemplate>
