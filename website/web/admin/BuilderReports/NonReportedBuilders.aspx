  <%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/controls/AdminMaster.master" Title="Builder Reporting Status" CodeFile="NonReportedBuilders.aspx.vb" Inherits="Index" %>
...
<h4>Builders - Report</h4>
<h4>Builders who created a  report with  Data but did not submit it .<br /> Allows Admin to submit it. </h4>
...
<td valign="top" class="field"><asp:textbox id="F_PeriodYear" runat="server" Columns="50" MaxLength="4" TextMode="Number" onkeypress="return this.value.length<=3"></asp:textbox></td>
</tr>

<tr>
<th valign="top">Period Quarter:</th>
<td valign="top" class="field"><asp:textbox id="F_PeriodQuarter" runat="server" Columns="50" MaxLength="2" TextMode="Number" onkeypress="return this.value.length<=1"></asp:textbox></td>
</tr>
<tr>
...
<asp:Button ID="btnSubmitAll" runat="server" Text="Submit Checked Purchase Reports" />
 <CC:GridView id="gvList" CellSpacing="2" CellPadding="2" runat="server" PageSize="50" AllowPaging="True" AllowSorting="True" HeaderText="In order to change display order, please use header links" EmptyDataText="There are no records that match the search criteria" AutoGenerateColumns="False" BorderWidth="0" PagerSettings-Position="Bottom" DataKeyNames ="BuilderID">
	...
	<Columns>
     <asp:TemplateField HeaderText="Select">
        ...
        <asp:TemplateField Visible=false>
         <ItemTemplate>
             <asp:Label id="ltlPurchasesReportID" runat ="server" text='<%# Eval("PurchasesReportID")%>' />
         </ItemTemplate>
      </asp:TemplateField>
		<asp:BoundField SortExpression="CompanyName" DataField="CompanyName" HeaderText="Vendor Name"></asp:BoundField>
        
  <asp:BoundField datafield="PurchasesReportID" HeaderText ="PeriodYear" Visible ="false" />
 ...
 <asp:TemplateField HeaderText="Last Updated Date">
  ...
  <asp:TemplateField>
		    <ItemTemplate>
		        <asp:Button ID="btnSubmitPurchasesReport" runat="server" Text="Submit Purchase Report" CssClass="btn submit campaignBtn" CommandName="SubmitPurchasesReport" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"PurchasesReportID") %>' />
		    </ItemTemplate>
		</asp:TemplateField>
	</Columns>
</CC:GridView> 
