<%@ Control Language="VB" AutoEventWireup="false" ClassName="Survey.Report.Controls.SelectOne" CodeFile="selectone.ascx.vb" Inherits="Survey.Report.QuestionType.SelectOne" %>
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 760px;" rules="all">
            ...
            <ItemTemplate>
                <tr class="row" height="26">
                    <td><a href="" enableviewstate="false" runat="server" id="lnkResult"><%#Container.DataItem("Name")%></a></td>
