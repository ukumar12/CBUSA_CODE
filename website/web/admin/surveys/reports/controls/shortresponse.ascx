<%@ Control Language="VB" AutoEventWireup="false" ClassName="Survey.Report.Controls.ShortResponse" CodeFile="shortresponse.ascx.vb" Inherits="Survey.Report.QuestionType.ShortResponse" %>
