<%@ Control Language="VB" AutoEventWireup="false" ClassName="Survey.Report.Controls.PercentRank" CodeFile="percentrank.ascx.vb" Inherits="Survey.Report.QuestionType.PercentRank" %>
