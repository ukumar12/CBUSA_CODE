<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" Inherits="EditProject"  Title="Plans Online - Projects"%>

<CT:MasterPage ID="CTMain" runat="server">
<div class="pckgwrpr bggray">
<div class="pckghdgltblue">
    Plans Online > <a href='default.aspx' >Projects</a> > <span style="font-size:20px;">Edit Project</span> <%--style="color:#0f2e51;"--%>
</div>
<div class="pckgbdy">
