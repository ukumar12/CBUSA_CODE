<%@ Page Language="VB" AutoEventWireup="false" CodeFile="update.aspx.vb" Inherits="builder_update" %>
...
<div id="divfuturePayment" runat ="server"  class="thememarket" style="width:500px;margin:25px auto;border:1px solid #c2c2c2">
    <div class="pckghdgred">CBUSA Fee Schedule</div>
    <table cellpadding="4" cellspacing="0" border="0" style="width:100%;margin:0px" class="tblcompr">
        <tr>
            <th>Item</th>
            <th>When Charged?</th>
            <th>Price</th>
...
<%--<div class="pckggraywrpr">
        ...
        <tr>
	     ...
	     <tr>
	        <td colspan="3" align="center">
	            <asp:CheckBox id="cbPolicy" runat="server" onclick="OpenPolicy();" Text="I agree to the payment and refund policy" checked="true"></asp:CheckBox><br />
    ...
    <p class="center">
        <CC:OneClickButton ID="btnSubmit" runat="server" Text="Submit" CssClass="btnred" ValidationGroup="UpdatePayment" />
        <asp:Button id="btnCancel" runat="server" text="Cancel" CSsclass="btnred" CausesValidation="false" onclientclick="history.go(-1);return false;" />
    </p>
</div>--%>

<%--<CC:RequiredFieldValidatorFront ID="rqtxtCardholderFirstName" runat="server" ControlToValidate="txtCardholderFirstName" ValidationGroup="UpdatePayment" EnableClientScript="False" Display="None" ErrorMessage="You must enter your credit cardholder name" />
<CC:RequiredFieldValidatorFront ID="rqtxtCardholderLastName" runat="server" ControlToValidate="txtCardholderLastName" ValidationGroup="UpdatePayment" EnableClientScript="False" Display="None" ErrorMessage="You must enter your credit cardholder name" />

<CC:CreditCardValidatorFront ID="cvtxtCardNumber" runat="server" ControlToValidate="txtCardNumber" ValidationGroup="UpdatePayment" EnableClientScript="False" Display="None" ErrorMessage="The credit card number you provided is not valid" />
<CC:CreditCardTypeValidatorFront ID="cvdrpCardType" runat="server" ControlToValidate="drpCardType" ValidationGroup="UpdatePayment" CreditCardNumberControl="txtCardNumber" EnableClientScript="False" Display="None" ErrorMessage="The credit card type doesn't match the credit card number" />
<CC:RequiredFieldValidatorFront ID="rqtxtCardNumber" runat="server" ControlToValidate="txtCardNumber" ValidationGroup="UpdatePayment" EnableClientScript="False" Display="None" ErrorMessage="You must enter your credit card number" />
<CC:RequiredFieldValidatorFront ID="rqtxtCID" runat="server" ControlToValidate="txtCID" ValidationGroup="UpdatePayment" EnableClientScript="False" Display="None" ErrorMessage="You must enter your card security code" />
<CC:RequiredExpDateValidatorFront ID="rqctrlExpDate" runat="server" ControlToValidate="ctrlExpDate" ValidationGroup="UpdatePayment" EnableClientScript="False" Display="None" ErrorMessage="You must provide expiration date" />
<CC:ExpDateValidatorFront ID="valctrlExpDate" runat="server" ControlToValidate="ctrlExpDate" ValidationGroup="UpdatePayment" EnableClientScript="False" Display="None" ErrorMessage="You must provide a valid expiration date" />
<CC:RequiredFieldValidatorFront ID="rqdrpCardType" runat="server" ControlToValidate="drpCardType" ValidationGroup="UpdatePayment" EnableClientScript="False" Display="None" ErrorMessage="You must enter your credit card type" />

<CC:RequiredFieldValidatorFront ID="rfvtxtAddress1" runat="server" ControlToValidate="txtAddress1" ValidationGroup="UpdatePayment" ErrorMessage="Billing Address Line 1 is required"></CC:RequiredFieldValidatorFront>
<CC:RequiredFieldValidatorFront ID="rfvtxtCity" runat="server" ControlToValidate="txtCity" ValidationGroup="UpdatePayment" ErrorMessage="Billing City is required"></CC:RequiredFieldValidatorFront>
<CC:RequiredFieldValidatorFront ID="rfvdrpState" runat="server" ControlToValidate="drpState" ValidationGroup="UpdatePayment" ErrorMessage="Billing State is required"></CC:RequiredFieldValidatorFront>
<CC:RequiredFieldValidatorFront ID="rfvtxtZip" runat="server" ControlToValidate="txtZip" ValidationGroup="UpdatePayment" ErrorMessage="Billing Zip Code is required"></CC:RequiredFieldValidatorFront>
<CC:ZipValidatorFront ID="zvftxtZip" runat="server" ControlToValidate="txtZip" ValidationGroup="UpdatePayment" ErrorMessage="Billing Zip Code is invalid"></CC:ZipValidatorFront>--%>
</CT:MasterPage>