...
<CC:PopupForm ID="frmAverage" runat="server" CloseTriggerId="btnCancelAverage" ShowVeil="true" ValidateCallback="true" ErrorPlaceholderId="spanAverageErrors" Animate="true" VeilCloses="true" cssclass="pform" style="text-align:center;">
    <FormTemplate>
            ...
            <table cellpadding="4" cellspacing="0" border="0" style="margin:15px;background-color:Transparent;">
                ...
                <tr>
                    <td colspan="2" style="text-align:center;">
                        <CC:OneClickButton id="btnAcceptAverage" runat="server" cssclass="btnred" commandname="Accept" text="Keep in order and accept unknown price" /><br /><br />
                        <CC:OneClickButton id="btnOmitAverage" runat="server" cssclass="btnred" commandname="Omit" text="Remove from order for this vendor only" /><br /><br />
                        <CC:OneClickButton id="btnRequestAverage" runat="server" cssclass="btnred" commandname="Request" text="Request pricing from this vendor" /><br /><br />
    ...
    <div class="pckggraywrpr">
        ...
        <asp:UpdatePanel ID="upOnJavascriptFormChanges" runat="server" UpdateMode="Conditional">
			<ContentTemplate>
        ...
        <Triggers>
        	...
        	<asp:AsyncPostBackTrigger ControlId="frmAverage" />
        </Triggers>
        </asp:UpdatePanel>
    </div>
