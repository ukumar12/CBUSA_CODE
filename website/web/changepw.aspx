...
<!--	
	function CheckAvailability() {
		...
		var xml = getXMLHTTP();
		if(xml){
			xml.open("GET","/ajax.aspx?f=CheckAvailbility&VendorAccountId=<%=VendorAccountId %>&PIQAccountId=<%=PIQAccountId %>&BuilderAccountId=<%=BuilderAccountId%>&Username=" + txtUsername.value,true);
...
function OpenEula() {
    var frm = $get('<%=frmEula.ClientID %>').control;
    frm._doMoveToCenter();
    frm.Open();
}
function AcceptEula() {
    var cb = $get('<%=cbTerms.ClientID %>');
    cb.checked = true;
    $get('<%=frmEula.ClientID %>').control.Close();
}
function RejectEula() {
    var cb = $get('<%=cbTerms.ClientID %>');
    cb.checked = false;
...
//-->
    ...
    <div class="pckggraywrpr" style="width:500px;margin:20px auto;">
        ...
        <table cellpadding="2" cellspacing="2" border="0">
            ...
            <tr id="trTitle" runat="server">
                ...
                <td class="field"><asp:TextBox id="txtTitle" runat="server" Maxlength="50" style="width:150px;"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="fieldlbl"><span id="labeltxtPhone" runat="server">Phone Number:</span></td>
                <td class="fieldreq" id="bartxtPhone" runat="server">&nbsp;</td>
                <td class="field"><asp:TextBox id="txtPhone" runat="server" maxlength="50" style="width:100px;"></asp:TextBox></td>
            </tr>
	        <tr valign="top">
        ...
        <table cellspacing="2" cellpadding="2" border="0" style="text-align:left;">
            <tr>
                ...
                <td class="field">
                    <asp:CheckBox ID="cbTerms" runat="server" onclick="OpenEula();" />&nbsp;<asp:Button id="btnShowTerms" runat="server" text="View Terms" cssclass="btnblue" />
                        ...
                        <FormTemplate>
                                <div class="pckggraywrpr" style="margin:0px;">
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                        <div style="MARGIN: 0in 0in 6pt" align="left"><font size="2" /><font size="2"><strong>SECURITY.</strong>&nbsp;You shall not, nor shall you permit any third party to, disable, circumvent, or otherwise avoid any security device, mechanism, protocol, or procedure established by CB-USA for use of the CB-USA System.&nbsp;You will immediately notify CB-USA if you become aware of any unauthorized use of the CB-USA System.&nbsp;</font></div>
                                        </li>
                                        <li>
                                    ...
                                    <table style="MARGIN: auto auto auto 0.2in; BORDER-COLLAPSE: collapse" cellspacing="0" cellpadding="0" border="0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <div style="MARGIN: 0in 0in 0pt" align="center"><asp:Button id="btnAcceptEula" runat="server" text="I HAVE READ AND UNDERSTOOD AND ACCEPT THIS AGREEMENT" cssclass="btnred" onclientclick="AcceptEula()" /><br /></div>
                                                </td>
                                                ...
                                                <div style="MARGIN: 0in 0in 0pt" align="center"><asp:Button id="btnCancelEula" runat="server" text="I REJECT THIS AGREEMENT" cssclass="btnred" onclientclick="RejectEula()" /></div>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>    
        ...
        <p style="text-align:center;">
            ...
            <asp:Button id="btnCancel" runat="server" text="Cancel" cssclass="btnred" onclientclick="location.href='/default.aspx'" />
        </p>   
    </div> 
    ...
    <CC:CompareValidatorFront ID="cvfPassword" runat="server" ControlToCompare="txtConfirmpassword" ControlToValidate="txtPassword" ErrorMessage="Password and Confirm Password do not match"></CC:CompareValidatorFront>
    ...
    <CC:RequiredFieldValidatorFront ID="rfvtxtTItle" runat="server" ControlToValidate="txtTitle" ErrorMessage="Title is empty"></CC:RequiredFieldValidatorFront>
    <CC:RequiredFieldValidatorFront ID="rfvtxtPhone" runat="server" ControlToValidate="txtPhone" ErrorMessage="Phone Number is empty"></CC:RequiredFieldValidatorFront>
</CT:MasterPage>