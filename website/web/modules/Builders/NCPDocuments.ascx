<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NCPDocuments.ascx.vb"    Inherits="modules_Builders_NCPDocuments" %>

  
<div class="pckgltgraywrpr">
    <div class="pckghdgred nobdr">
       
        <asp:Button runat="server" CssClass = "btnred" ID="btndashboard" Text= "DashBoard" style="margin-left:630px;float:right;"  /> National Contracts Program
    </div>
    <div class="Contracttblwrpr themeprice">
        <asp:Repeater ID="rptVendors" runat="server">
            ...
            <ItemTemplate>
                <div class="bdbtblhdg">
                    <div class="caption">
                        <asp:Literal ID="ltlName" runat="server" /><%# Eval("Name")%>
                    </div>
                    <div class="clear">
                        &nbsp;</div>
                </div>
                ...
                <%# Eval("Description")%>
                <asp:Literal ID="ltlContentID" runat="server" Text='<%# Eval("NCPContentID")%>' Visible="false" />
