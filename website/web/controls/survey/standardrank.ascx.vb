        ...
        Public Class StandardRank
            ...
            Public Function Validate() As Boolean
                If Question.IsRequired Then
                    ...
                    Dim sRankings As String = ",", i As Integer

                    For i = 1 To rptChoices.Items.Count
                        sRankings &= i.ToString & ","
                    Next
                    ...
                    For Each item In Me.rptChoices.Items
                        ...
                        Try
                            i = txt.Text
                            sRankings = Replace(sRankings, "," & i.ToString & ",", ",")
                    ...
                    If sRankings <> "," Then
                        ...
                        AddError("Please rank all items from 1 to " & rptChoices.Items.Count)
                        Return False
                    End If
