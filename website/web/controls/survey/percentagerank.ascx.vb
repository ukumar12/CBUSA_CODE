        ...
        Public Class PercentageRank
            ...
            Protected Sub rptChoices_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rptChoices.ItemDataBound
                If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
                    ...
                    Dim txt As TextBox = e.Item.FindControl("txtChoice")
                    txt.Attributes.Add("ChoiceId", e.Item.DataItem("ChoiceId"))
                    txt.Attributes.Add("QuestionId", e.Item.DataItem("QuestionId"))
                    txt.Attributes.Add("ShowResponse", e.Item.DataItem("ShowResponseField"))
