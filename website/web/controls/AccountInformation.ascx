<%@ Control Language="VB" AutoEventWireup="false" CodeFile="AccountInformation.ascx.vb" Inherits="controls_AccountInformation" %>
...
<div class="cblock10">
	...
	<div class="aieditlink" id="divlink" runat="server" ><a id="lnkEditLink"  runat="server" class="aieditlink" href="javascript:void(0);">[Edit]</a></div>
            ...
            <h3 >Edit Account Information</h3>
                ...
                <table>
	                ...
	                <tr>
		                ...
		                <td><asp:RequiredFieldValidator ID="rfvState" runat="server" Display="Dynamic" ControlToValidate="txtState" ErrorMessage="Field 'State' is blank"></asp:RequiredFieldValidator></td>
	                </tr>
	                <tr>
