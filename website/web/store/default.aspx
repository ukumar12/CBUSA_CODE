<%@ Page Language="VB" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="store_default" %>
...
<asp:Panel runat="server" id="pnlDepartments" visible="false">
	...
	<ItemTemplate>
		...
		<div runat="server" id="divSpacer" visible="False" style="clear:both;" enableviewstate="false">&nbsp;</div>
	</ItemTemplate>
    </asp:Repeater>
    </div>
</asp:Panel>
