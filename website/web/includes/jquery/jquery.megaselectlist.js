(function ($) {
    ...
    $.fn.megaselectlist = function (settings) {
        ...
        return this.each(function () {
            ...
            $("#" + classModifier + nextModifierNumber + " span").text(unescape(spanText));
            ...
            $("#" + classModifier + nextModifierNumber + " li").click(function () {
				...
				var list = spanText.split(config.itemseparator);
				list.sort();
				spanText = "";
				list.forEach(function(entry) {
					spanText += entry + config.itemseparator;
				});
				
                spanText = spanText.substring(0, spanText.length - config.itemseparator.length);
					
                // Set span to show current selections
                $(item).parents("." + classModifier).find("span").html(spanText);
