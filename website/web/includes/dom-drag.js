...
function showQW(e,ctrlName) {
	...
	tempX+=10; tempY+=7; 
	qwdrag.style.left=tempX;
	qwdrag.style.top= tempY;
...
document.write('<div id="qwdrag" style="display:none;">');
...
document.write('<a href="#" onClick="hideQW();"><img src="/images/utility/sa-close.gif" width="47" height="19" border="0" alt="Close" /></a><br />');
document.write('</div>');
document.write('</div>');
...
var theHandle = document.getElementById("qwtop");
var theRoot   = document.getElementById("qwdrag");
