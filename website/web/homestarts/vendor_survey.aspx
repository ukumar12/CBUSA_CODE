<%@ Page Language="VB" AutoEventWireup="false" CodeFile="vendor_survey.aspx.vb" Inherits="homestarts_vendorsurvey" %>
                        ...
                        <td style="width: 45%;" valign="top">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="width: 100%; text-align: center"><span class="survey-header">Net Promoter Score Survey</span></td>
                                </tr>
                                <tr style="height: 25px;">
                                    <td colspan="3"></td>
                                        ...
                                        <table style="width: 100%">
                                            <%--<tr style="height: 30px;">
                                                <td align="center" valign="top"><b>
                                                    <asp:Label runat="server" ID="lblActualStart" CssClass="info" Text=""></asp:Label></b> Actual Starts

                                                    <asp:TextBox TextMode="Number" ID="txtActualStart" onchange="enableSubmitButton()" runat="server" Width="60px" Font-Size="Medium"></asp:TextBox><br />
                                                ...
                                                <asp:TextBox TextMode="Number" ID="txtProjectedStart" onchange="enableSubmitButton()" runat="server" Width="60px" Font-Size="Medium"></asp:TextBox><br />
                                            ...
                                            <tr style="height: 30px;">
                                                <td align="center" colspan="2">
                                                    ...
                                                    <div id="dvNetPromoter" style="margin-top: 20px;">
                                                        <label class="NetPromoter_Header" style="margin: 5px 0px 5px 5px; float: left; color: #0e2d50; clear: both;">On a scale from 0 to 10, how likely are you to recommend CBUSA to another vendor?</label><br />
                                            ...
                                            <tr style="height: 50px;">
                                                <td colspan="2" align="center" valign="bottom">
                                                    <asp:Button runat="server" CssClass="submit-btn" ID="btnSubmitSurvey" OnClick="btnSubmitSurvey_Click" CausesValidation="true" ValidationGroup="survey" Enabled="false" Text="SUBMIT MY SCORE" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <asp:Panel runat="server" ID="pnlAlreadySubmittedSurvayData" Visible="false">
                                            <div class="message">
                                                Thank you for your response! You can review the results of Home Starts Survey taken by builders of your market and the entire CBUSA network by clicking <a href="vendor_survey_report.aspx?<%= sReportUrl %>">here</a>.                                                
                                            </div>
                                        </asp:Panel>
                                        ...
                                        <asp:Panel runat="server" ID="pnlSuccess" Visible="false">
                                            <div class="message">
                                                Thank you for your response!  You can review the results for your market and the entire CBUSA network by clicking <a href="vendor_survey_report.aspx?<%= sReportUrl %>">here</a>.

                                            </div>
                                        </asp:Panel>
                                        <asp:Panel ID="pnlBestPersion" runat="server" Visible="true" Style="padding: 10px; background-color: #d7dadb;">
                                            <table style="width:100%;">
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;<asp:RadioButton runat="server" Text="Yes" value="Y" Checked="true" AutoPostBack="true" OnCheckedChanged="rbBestPersion_CheckedChanged" GroupName="grpBest" ID="rbBestPersionY" /><br />
                                                        &nbsp;&nbsp;&nbsp;&nbsp;<asp:RadioButton runat="server" Text="No. Please don't send me these surveys." AutoPostBack="true" value="N" GroupName="grpBest" OnCheckedChanged="rbBestPersion_CheckedChanged" ID="rbBestPersionN" />
                                                        <br />
                                                        <br />
                                                    </td>
                                                </tr>
