...
<p>
    <a id="aNewTakeoff" runat="server" href="select-builder.aspx">Back To Select Builder For Takeoff Screen</a>
</p>

<asp:UpdatePanel ID="upFilterBar" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
    <ContentTemplate>
    <asp:Panel runat="server" DefaultButton="btnSearch">
          <table cellpadding="0" cellspacing="0" border="0" class="takeofffltrbar">
            <tr>
                <td class="pckghdgclr" style="padding: 15px 22px 5px 14px; width: 200px">Select Products From:</td>
                <td style="display :none; padding: 15px 0px">
                    <span class="hdg">Projects:</span><br />
                ...
                <td style="padding: 15px 0px">
                    <span style="color: #blue;float: left; font-weight: bold; margin: 3px 2px 0 0; ">Orders: </span>
                ...
                <td style="padding: 15px 0px">
                    <span style="color: #blue;float: left; font-weight: bold; margin: 3px 2px 0 0;">Takeoffs: </span>
                ...
                <td  style="padding: 10px 0px">
                    <asp:ImageButton title="Add Products From Selected Take-off" ID="btnAdd" runat="server" ImageUrl="/images/global/btn-fltrbar-add.png" AlternateText="Add Related Products to Take-off" style="width:28px;border:none;height:26px;" />
                </td>
                <td  style="padding: 10px 0px">
                    <asp:ImageButton ID="btnUpload" runat="server" ImageUrl="/images/global/btn-fltrbar-upload.png" AlternateText="Upload Products to Take-off" title="Upload Products to Take-off" style="width:28px;border:none;height:26px;" onclientclick="return OpenUploadProduct();"   />
                </td>
                <td  style="padding: 10px 0px">
                    <asp:ImageButton ID="btnSpecial" runat="server" ImageUrl="/images/global/btn-fltrbar-addspecial.png" alternatetext="Add Special Order Product to Take-off" title="Add Special Order Product to Take-off" style="width:28px;border:none;height:26px;" onclientclick="return OpenSpecialForm();" />
                </td>
                <td  style="padding: 10px 0px">
      ...
      <tr valign="top">
        <td class="leftcol">
            ...
            <ContentTemplate>
                <div class="leftcolwrpr">
                    <div class="pckghdgtakeoff">1. Select Category</div>
                    <div class="redbox" style="padding:0px">
                        <ul>
                    ...
                    <CC:Search ID="ctlSearch" runat="server" KeywordsTextboxId="txtKeyword" PageSize="16" /> 
                </div>
            </ContentTemplate>          
        </asp:UpdatePanel>
        ...
        <td class="maincol">
            <div class="maincolwrpr">
                <div class="pckghdgred autoHeight">2. Input Quantities for Desired Products and Add to Takeoff</div>
                    ...
                    <asp:Panel ID="pnlPreferredVendor" runat="server" visible="false">
                        <table cellpadding="0" cellspacing="0" border="0" class="takeofffltrbar">
                        <tr>
                        <td class="subhdgtakeoffvendor">Select a Preferred Vendor:</td>
                        <td style="background-color: #e1e1e1;padding-top: 15px;">
                ...
                <asp:UpdatePanel id="upProducts" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                    <ContentTemplate>
                        <div ><asp:Literal id="ltlBreadcrumb" runat="server" enableviewstate="false"></asp:Literal></div>
                            ...
                            <asp:Repeater id="rptProducts" runat="server">
                                <ItemTemplate>
                                    <tr class='<%#IIf(Container.ItemIndex Mod 2 = 1, "", "alt") %>'>
                                        ...
                                        <td>
                                            <asp:Button id="btnAddProduct" runat="server" Text="Add" onclientclick='<%# "return AddProductForm(""" & Container.UniqueId &""","""& DataBinder.Eval(Container.DataItem,"ProductID") & """);" %>' cssclass="btnred" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ProductID") %>'></asp:Button>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
        ...
        <td class="rightcol">
            <div class="rightcolwrpr">
                <div class="pckghdgtakeoff">3. Review Take-off & Process</div>
                <div class="subhdgtakeoff" style="padding: 0 10px 12px ;border:0px">
                    <asp:Label id="lblTakeoffTitle" runat="server" cssclass="larger center" style="display:block;"></asp:Label><br />
                    <span style="float:left;width:50%"><asp:LinkButton id="btnSaveTop" runat="server" onclientclick="return OpenSaveForm(event,false);">Save Take-off</asp:LinkButton></span>
                     <%--<span style="width:50%;text-align:right;padding-left: 30px;">--%><span style="width:50%;text-align:right;padding-left: 12px;"><asp:LinkButton id="btnCopyTop" runat="server" onclientclick="return OpenSaveForm(event,true);">Copy Take-off</asp:LinkButton></span>
                      <span style="width:50%;text-align:right;padding-left: 47px;"><asp:LinkButton id="btnSendTop" runat="server" onclientclick="OpenSendForm(); return false;">Send to Builder</asp:LinkButton>
                ...
                <div id="divComparisonLinkTop" runat="server" class="bold center " style="background-color: #fff;padding:10px 4px;"><a class="blulnk" href="/comparison/default.aspx">Select Vendors for Price Comparison</a> </div> 
                ...
                <div id="divComparisonLinkBtm" runat="server" class="bold center " style="padding:10px 4px;"><a class="blulnk" href="/comparison/default.aspx">Select Vendors for Price Comparison</a> </div> 
                <div class="bold center bgltblue" style="padding:10px;">
                ...
                <div class="btnhldctr"><asp:Button id="btnUpdate" runat="server" cssclass="btngold" text="Update Quantities" /></div> <%--btnhldrrt--%>
            </div>
        </td>
    </tr>
</table>
...
<div id="divSpecialOrderForm" runat="server" class="window" style="visibility:hidden;width:450px;">
    <div class="pckggraywrpr" style="margin:0px">
...
<div id="divSaveForm" runat="server" class="window" style="width:300px;">
    <div class="pckggraywrpr" style="margin:0px">
...
<div id="divProductQty" runat="server" class="window" style="visibility:hidden;width:350px;">
