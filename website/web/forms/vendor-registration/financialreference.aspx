<%@ Page Language="VB" AutoEventWireup="false" CodeFile="financialreference.aspx.vb" Inherits="forms_vendor_registration_financialreference" %>
...
<h4>Financial Reference Info</h4>
<table class="regform">
    <tr>
        <td>&nbsp;</td>
    ...
    <tr>
        <td class="fieldlbl"><span id="labeltxtFirstName" runat="server">Contact First Name:</span></td>
    ...
    <tr>
        <td class="fieldlbl"><span id="labeltxtLastName" runat="server">Contact Last Name:</span></td>
