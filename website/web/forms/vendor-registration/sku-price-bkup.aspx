<%@ Page Language="VB" AutoEventWireup="false" CodeFile="sku-price-bkup.aspx.vb" Inherits="skuprice" EnableEventValidation="false" %>
<%@Register TagName="Search" TagPrefix="CC" Src="~/controls/Search.ascx" %>
...
<table class="tblnwto" cellpadding="0" cellspacing="0" border="0">
    <tr valign="top">
        <td class="leftcol">
            ...
            <div class="pckghdgred" style="height:15px;">Supply Phase Tree</div>
            ...
            <ContentTemplate>
                <div style="background-color:#fff;" class="bdr">
                    ...
                    <CC:Search id="ctlSearch" runat="server" PageSize="10000" ShowTitle="False"></CC:Search>
            </ContentTemplate>
        </asp:UpdatePanel>
            </div>
                ...
                <asp:UpdatePanel id="upProducts" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                    <ContentTemplate>
                        ...
                        <div style="margin-top:10px; margin-bottom:10px; margin-left:5px;">
                            ...
                            <table class="tbltodata" cellpadding="0" cellspacing="0" border="0" width="759">
                            <tr>
                                ...
                                <ItemTemplate>
                                    <tr class='<%#iif(Container.ItemIndex mod 2 = 1,"","alt") %>' id="trVendor" runat="server">
                                        ...
                                        <td align="center">
                                            ...
                                            <asp:LinkButton id="btnSubstitute" runat="server" cssclass="smaller" OnClientClick='<%# "return OpenSubstitute(""" & Convert.ToString(DataBinder.Eval(Container.DataItem,"ProductID")) &""","""& convert.tostring(dataBinder.Eval(Container.dataItem,"Product")).Replace("""","\""") &""");" %>'></asp:LinkButton>
                                            <asp:LinkButton id="btnRemoveSub" runat="server" cssclass="smaller" Text="Remove" onclientclick='<%# "ConfirmRemoveSub("& Container.DataItem.ProductID &");return false;"%>' />
                                        </td>
                                        <td style="text-align:center;">
...
<div id="divSkuPrice" runat="server" class="window" style="visibility:hidden;border:1px solid #000;background-color:#fff;width:350px;">
    <div class="pckghdgred">Initial Product Sku and Price Import</div>
    <div style="margin-left:10px;margin-right:10px">
        <br />
        <p>Use this form if you wish to price new products and match your company sku to them</p>
        <p><asp:LinkButton ID="btnExport" Text="Get SKU Matching/Pricing File"  cssclass="bold" runat="server" onclientclick="SwapTarget();" OnClick="ExportCSV" /> <span class="smallest">(Import file must match the template exactly including the header line)</span></p>
        <center>
                        ...
                        <td>
                            ...
                            <div class="pckghdgblue">
                                <div style="float:left;margin-right:100px;">
                                    <span class="largest center" >Substitute product for:<br /><span runat="server" class="smaller" ID="spanSubHeaderProduct"></span></span>
                                </div>
                            ...
                            <table class="tblcompr" cellpadding="2" cellspacing="0" border="0" style="width:100%;">
                                <tr>
                                    <th>My SKU</th>
                                    <th>CBUSA SKU</th>
                                    <th>Name</th>
                            ...
                            <asp:Repeater ID="rptResults" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><span id="spanName" runat="server"><%#DataBinder.Eval(Container.DataItem,"ProductName") %></span></td>
                                        <td>
