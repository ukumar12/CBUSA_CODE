...
Partial Class pricing
    ...
    Private Sub BindProducts()
        ...
        Else
            ...
            ltlBreadcrumb.Text = "<a href=""/"">Home</a> > <a href=""pricing.aspx?sp=N"">All Supply Phases</a> > " & SupplyPhaseRow.GetRow(DB, Session("SupplyPhase")).SupplyPhase
        End If
        If txtKeyword.Text <> String.Empty And txtKeyword.Text <> "Keyword Search" Then
            ...
            SQL &= ")"
            ltlBreadcrumb.Text = "<a href=""/"">Home</a> > <a href=""pricing.aspx?sp=N"">All Supply Phases</a> > " & txtKeyword.Text
            Session("SupplyPhase") = String.Empty
        End If
