<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pricing.aspx.vb" Inherits="pricing" EnableEventValidation="false" %>
            ...
            <div class="maincolwrpr">
                ...
                <div style="float:right; margin-top:-32px; margin-right:5px;">
                    <asp:DropDownList id="drpMatchingType" runat="server" autopostback="true">
                        ...
                        <asp:listitem value="sku.aspx">Enter prices later</asp:listitem>
                        <asp:listitem value="pricing.aspx" selected>Enter SKUs later</asp:listitem>
                    </asp:DropDownList>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:Repeater id="rptProducts" runat="server">
                            ...
                            <tr>
                                ...
                                <th align="center" colspan="2">Vendor Price</th>
                                <th colspan="4"></th>
                            </tr>
                            <tr>
                                <th></th>
                                ...
                                <ItemTemplate>
                                    <tr class='<%#iif(Container.ItemIndex mod 2 = 1,"","alt") %>' id="trVendor" runat="server">
                                        ...
                                        <td><%#DataBinder.Eval(Container.DataItem, "VendorPrice")%></td>
                                        <td><asp:TextBox id="txtPrice" runat="server" maxlength="12" columns="6" class="inptqty"></asp:TextBox></td>
