...
Partial Class supply_phase
    ...
    Protected Sub BindSupplyPhases()
        ...
        Dim dtSupplyPhases As DataTable = DB.GetDataTable(SQL)

        If dtSupplyPhases.Rows.Count > 0 Then
            tvVendorSupplyPhases.DataSource = dtSupplyPhases
            ...
            tvVendorSupplyPhases.Visible = True
        Else
            tvVendorSupplyPhases.Visible = False
        End If
    End Sub
    ...
    Protected Sub btnSKU_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSKU.Click
        Response.Redirect("sku.aspx")
    End Sub
    Protected Sub btnPrice_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrice.Click
    ...
    Protected Sub btnSKUPrice_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSKUPrice.Click
        Response.Redirect("sku-price.aspx")
    End Sub
End Class
