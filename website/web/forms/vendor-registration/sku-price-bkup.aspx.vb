        ...
        If rblSubPricedOnly.SelectedValue = True Then
            Dim q = From sr As DataRow In tbl.AsEnumerable _
                    ...
                    { _
                        ...
                        .ProductSku = sr("SKU"), _
                        .ProductName = sr("ProductName"), _
                        .Description = sr("Description"), _
                        .UnitOfMeasure = sr("SizeUnitOfMeasureText") _
                    }
...
#End Region
    ...
    Private Sub UpdateSearch(Optional ByVal ClearFacets As Boolean = False)
        Dim list As New Generic.List(Of String)
        GetFilterList(list)
        ctlSearch.filterlist = list
        ctlSearch.search(ClearFacets)
    End Sub
