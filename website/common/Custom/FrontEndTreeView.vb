...
Namespace Controls
    Public Class FrontEndTreeView
        ...
        Private Sub ExpandChildren(ByVal Parent As FrontEndTreeNode)
            ExpandList.Add(Parent.Key)
        ...
        '    Dim AsyncTrigger As New UnvalidatedPostback()
        '    AsyncTrigger.ID = "btnAsyncTrigger"
        '    Controls.Add(AsyncTrigger)
        '    Dim sm As ScriptManager = ScriptManager.GetCurrent(Page)
        '    If sm IsNot Nothing Then
        '        sm.RegisterAsyncPostBackControl(AsyncTrigger)
        '    End If

        '    Dim SyncTrigger As New UnvalidatedPostback()
        '    SyncTrigger.ID = "btnSyncTrigger"
        '    Controls.Add(SyncTrigger)
        'End Sub
